...
git clone https://github.com/danyllosoareszup/loja-virtual-testes.git /opt/lojavirtual
mkdir /opt/lojavirtual/logs
...
bash -c 'cd /opt/lojavirtual && git checkout main && make start'
